...
As of 2026-06-30, the US economy shows the following EWM Z-score cycle signals:
  ...
  Composite Growth Z-score:    +0.113  (above-trend (expansionary))
    [CLI 50% + INDPRO 20% + inv. Jobless Claims 15% + inv. UNRATE 15%]
  Composite Inflation Z-score: +0.342  (above-trend (inflationary))
...
Growth Indicators (latest available):
  ...
  Initial Jobless Claims (ICSA):   211k/week  (inverted; rising = weakening labor; 15% weight)
  Industrial Production (INDPRO):  102.50  (coincident output; 20% weight)
  Unemployment Rate (UNRATE):      4.3%  (inverted; 15% weight)

Inflation Indicators (latest available):
  5Y Breakeven Inflation (T5YIE):  2.51%  (market-implied forward inflation; 30% weight)
  Core CPI YoY (CPILFESL):         2.37%  (vs 2% Fed target; 25% weight)
  PPI Final Demand YoY (PPIFID):   5.40%  (pipeline inflation; 20% weight)
  CPI MoM Annualized:              4.61% (as of 2026-04)  (real-time inflection; vs 2% target; 15% weight)
  Capacity Utilization (TCU):      76.1%  (demand-pull pressure; 10% weight)

Reference (not in composite):
  Real GDP (GDPC1):                24152.66

Algorithmically-determined phase: Overheat
Clock hand position: 71.8 degrees (0 = 12 o'clock, clockwise)
...
6-Month Trajectory:
  ...
  2026-06  growth_z=+0.113  inflation_z=+0.342  phase=Overheat

Previous Claude evaluation (2026-05-09):
  Phase:     Overheat at 90.0% confidence
  Direction: counterclockwise
  Summary:   • Growth Z +0.158 and Inflation Z +0.117 both positive; Overheat at 36.37°
• Hormuz blockade snapped inflation Z from -0.054 to +0.117 in two months
• Growth rebounded from Apr +0.086 dip; AI capex supercycle absorbing inflation tax
• CLI 99.85 below 100; signals growth contraction ahead with 2Q lea
