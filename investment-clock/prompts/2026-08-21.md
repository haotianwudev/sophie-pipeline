...
As of 2026-08-31, the US economy shows the following EWM Z-score cycle signals:
  ...
  Composite Growth Z-score:    +0.256  (above-trend (expansionary))
    [CLI 50% + INDPRO 20% + inv. Jobless Claims 15% + inv. UNRATE 15%]
  Composite Inflation Z-score: -0.365  (below-trend (disinflationary))
...
Growth Indicators (latest available):
  ...
  Initial Jobless Claims (ICSA):   206k/week  (inverted; rising = weakening labor; 15% weight)
...
Clock hand position: 305.0 degrees (0 = 12 o'clock, clockwise)
...
6-Month Trajectory:
  ...
  2026-08  growth_z=+0.256  inflation_z=-0.365  phase=Recovery
