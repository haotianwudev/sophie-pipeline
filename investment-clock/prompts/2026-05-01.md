...
As of 2026-05-31, the US economy shows the following EWM Z-score cycle signals:

  Composite Growth Z-score:    +0.147  (above-trend (expansionary))
    [CLI 50% + INDPRO 20% + inv. Jobless Claims 15% + inv. UNRATE 15%]
  Composite Inflation Z-score: +0.169  (above-trend (inflationary))
...
Inflation Indicators (latest available):
  5Y Breakeven Inflation (T5YIE):  2.69%  (market-implied forward inflation; 30% weight)
  Core CPI YoY (CPILFESL):         2.22%  (vs 2% Fed target; 25% weight)
  PPI Final Demand YoY (PPIFID):   3.95%  (pipeline inflation; 20% weight)
...
Reference (not in composite):
  Real GDP (GDPC1):                24174.53

Algorithmically-determined phase: Overheat
Clock hand position: 49.0 degrees (0 = 12 o'clock, clockwise)
...
6-Month Trajectory:
  ...
  2026-05  growth_z=+0.147  inflation_z=+0.169  phase=Overheat

Previous Claude evaluation (2026-04-25):
  Phase:     Overheat at 90.0% confidence
  Direction: counterclockwise
  Summary:   • Growth Z +0.086 technically Overheat but declining; CLI 99.85 crossed below 100 contraction threshold.
• Counter-clockwise snap: inflation Z surged +0.208 in one month while growth momentum hemorrhaged.
• PPI YoY 4.24% and 5Y breakeven 2.59% confirm structural cost-push inflation above Fed target.
