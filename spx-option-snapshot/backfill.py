...
from src.tools.options_math import bs_price, solve_iv, compute_greeks  # noqa: F401 (re-exported for backwards compat)
...
# ---------------------------------------------------------------------------
# Black-Scholes Solver -- moved to src/tools/options_math.py so the OptionsDX
# unified re-derivation (convert_optionsdx_unified.py) shares the exact same
# implementation instead of a second copy. Imported above.
# ---------------------------------------------------------------------------
